    ...
    private static async Task SeedRolesAsync(ApplicationDbContext dbContext)
    {
        var roles = new[]
        {
            ...
            new Role
            {
                ...
                Permissions = "{\"markets:read\": true, \"products:read\": true, \"products:create\": true, \"products:update\": true, \"products:delete\": true, \"sales:read\": true, \"sales:create\": true, \"sales:update\": true, \"sales:delete\": true, \"inventory:create\": true, \"inventory:read\": true, \"stock:update\": true, \"stock:adjust\": true, \"inventory:delete\": true, \"inventory-movements:read\": true, \"stock:transfer\": true, \"purchases:read\": true, \"purchases:create\": true, \"purchases:update\": true, \"purchases:delete\": true}"
            },
            new Role
            {
                Name = "DepartmentManager",
                Description = "Department-level manager",
                Permissions = "{\"markets:read\": true, \"products:read\": true, \"inventory:read\": true, \"stock:update\": true, \"stock:adjust\": true, \"inventory-movements:read\": true, \"stock:transfer\": true}"
            },
            new Role
            {
                Name = "InventoryEmployee",
                Description = "Stock and inventory employee",
                Permissions = "{\"markets:read\": true, \"products:read\": true, \"inventory:read\": true, \"stock:update\": true, \"stock:adjust\": true, \"inventory-movements:read\": true}"
            },
            new Role
            {
                Name = "Seller",
                Description = "Creates sales and handles POS operations",
                Permissions = "{\"markets:read\": true, \"products:read\": true, \"sales:create\": true, \"inventory:read\": true}"
            }
        };
