...
public sealed class TenantIntegrationTestDatabase : IAsyncDisposable
{
    ...
    {
        ["RootAdmin"] = ("Platform administrator", "{\"all\": true}"),
        ...
        ["MainOperator"] = ("Market-level manager", "{\"products:read\": true, \"products:create\": true, \"products:update\": true, \"products:delete\": true, \"sales:read\": true, \"sales:create\": true, \"sales:update\": true, \"sales:delete\": true, \"inventory:create\": true, \"inventory:read\": true, \"inventory:update\": true, \"inventory:delete\": true, \"purchases:read\": true, \"purchases:create\": true, \"purchases:update\": true, \"purchases:delete\": true}"),
        ["DepartmentManager"] = ("Department-level manager", "{\"products:read\": true, \"inventory:create\": true, \"inventory:read\": true, \"inventory:update\": true, \"inventory:delete\": true}"),
        ["InventoryEmployee"] = ("Stock and inventory employee", "{\"products:read\": true, \"inventory:read\": true, \"inventory:update\": true}"),
        ["Seller"] = ("Creates sales and handles POS operations", "{\"products:read\": true, \"sales:create\": true, \"inventory:read\": true, \"inventory:update\": true}")
    };
